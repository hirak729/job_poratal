                ...
                <div class="card shadow border-0">
                    <div class="job_details_header">
                        <div class="single_jobs white-bg d-flex justify-content-between">
                            ...
                            <div class="jobs_right">
                                <div class="apply_now">
                                    @php 
                                    $isSaved = $count == 1 ? 'save-job' : '';
                                    @endphp
                                    <a class="heart_mark {{ $isSaved }}" href="javascript:void(0);"> <i class="fa fa-heart-o" aria-hidden="true"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="pt-3 text-end">
                            ...
                            @if (Auth::check())
                            <form action="{{ route('applyJob') }}" method="POST" onsubmit="return confirm('Are you sure you want to apply on this job?');" style="display:inline;">
                                @csrf
                                <input type="hidden" name="id" value="{{ $job->id }}">
                    ...
                    <div class="job_sumary">
                        ...
                        <div class="job_content pt-3">
                            <ul>
                                ...
                                @endif
                                @if (!empty($job->salary))
                                <li>Webite: <span><a href="https://{{ $job->company_website }}" target="_blank">{{ $job->company_website }}</a></span></li>
                                @endif
                            </ul>
                        </div>
                    </div>
